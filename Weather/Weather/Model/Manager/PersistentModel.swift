...
class PersistentModel: NSObject {
    ...
    lazy var backmanagedObjectContext: NSManagedObjectContext = {
        ...
        backgroundmanagedObjectContext.parent = self.mainManagedObjectContext
